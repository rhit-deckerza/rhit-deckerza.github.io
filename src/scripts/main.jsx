    ...
    render(){
        return(
            <div className="ProjectsPage">
                <ProjectItems isUnmounting={this.props.isUnmounting} path={'public/information/projects.json'} backgroundIsStill={this.props.backgroundIsStill}></ProjectItems>
            </div>
        )
    }
}
    ...
    render(){
        return(
            <div className="ProjectsPage">
                ...
                <ProjectItems isUnmounting={this.props.isUnmounting} path={'public/information/expirences.json'} backgroundIsStill={this.props.backgroundIsStill}></ProjectItems>
            </div>
        )
    }
}
